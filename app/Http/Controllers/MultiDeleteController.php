...
class MultiDeleteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        \LogActivity::addToLog('Multi Data Added Successfully');
    ...
    public function update(Request $request)
    {
        ...
        \LogActivity::addToLog('Multi Data Updated Successfully');
    ...
    public function destroy($id)
    {
        ...
        \LogActivity::addToLog('Single Data Deleted Successfully');
        $data->delete();
    }
    ...
    public function mass(Request $request)
    {
        ...
        \LogActivity::addToLog('Multi Data Deleted Successfully');
        if($joy->delete())
        {
            return 'Data Deleted !!!!!';
        }
